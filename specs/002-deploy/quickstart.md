...
Сейчас так и есть — любой workflow падает при старте. Причина на стороне аккаунта; посмотреть баннер на странице запуска и биллинг Actions. До починки деплой с ноутбука теми же шагами:
