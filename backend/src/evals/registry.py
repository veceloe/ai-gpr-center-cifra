...
Ограничение называем вслух: 42 фактические карточки с исходной нумерацией до 46 —
не бенчмарк, а верхнеуровневая проверка на реальных данных заказчика.
Расширение эталона — открытый вопрос OQ-08.
"""
